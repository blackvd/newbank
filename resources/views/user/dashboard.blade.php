        ...
        <div class="widget widget-account-invoice-two">
            <div class="widget-content">
                <div class="account-box">
                    <div class="info">
                        <div class="inv-title">
                            <h5 class="">Solde Compte Courant</h5>
                        </div>
                        <div class="inv-balance-info">

                            <p class="inv-balance">0.00 FCFA</p>
                            
                            <span class="inv-stats balance-credited">+ 0.00</span>
        ...
        <div class="widget widget-account-invoice-two">
            <div class="widget-content">
                <div class="account-box">
                    <div class="info">
                        <div class="inv-title">
                            <h5 class="">Solde Compte Épargne</h5>
                        </div>
                        <div class="inv-balance-info">
        ...
        <div class="widget widget-card-four">
            <div class="widget-content">
                ...
                <div class="w-content">
                    ...
                    <div class="w-info">
                        <p class="value">0.00 FCFA <span>Cette semaine</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></p>
                    </div>
                ...
                <div class="w-progress-stats">                                            
                    <div class="progress">
                        <div class="progress-bar bg-gradient-secondary" role="progressbar" style="width: 0%" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
    ...
    <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-chart-three">
            <div class="widget-heading">
                <div class="">
                    <h5 class="">Rapport Crédit/Débit</h5>
                </div>
