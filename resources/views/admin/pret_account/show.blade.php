            ...
            <div class="widget-content widget-content-area">
                ...
                <div class="form-row col-8">
                    <div class="form-group col-4">
                        <form action="{{ route('pret.eligibilite',['id'=>$client->id]) }}" method="post" >
                            @csrf
                            <button type="submit" id="pretEliBtn" class="btn btn-info">Eligibiliter</button>
                        </form>
                    </div>

                    <div class="form-group col-4">
                        <form action="{{ route('pret.accorder',['id'=>$client->id]) }}" method="post" >
                            @csrf
                            <input type="submit" class="btn btn-success" value="Accorder">
                        </form>
                    </div>
