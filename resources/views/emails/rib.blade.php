...
<p style="margin: 0; font-size: 18px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 22px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 18px; color: #000000;">Voici le rib <strong>{{$compte->rib}}</strong> du compte <strong>{{ $compte->numero_compte }}</strong></span></p>
<p style="margin: 0; font-size: 18px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 22px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 18px; color: #000000;">Merci de nous faire confiance.</span></p>
</div>
</div>
{{--  <!--[if mso]></td></tr></table><![endif]-->
