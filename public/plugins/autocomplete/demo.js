...
$(function () {
    ...
    // Initialize autocomplete with custom appendTo:
    $('#nationalite').autocomplete({
        lookup: countriesArray
    });

    $('#paysResidence').autocomplete({
        lookup: countriesArray
    });

    $('#paysEmission').autocomplete({
        lookup: countriesArray
    });

    var cities = ["Abengourou","Abidjan","Adzopé","Agboville","Agnibilékrou","Akoupé","Anyama","Bingerville","Bondoukou","Bouaflé","Bouaké","Boundiali","Dabou","Daloa","Danané","Daoukro","Dimbokro","Divo","Duékoué","Ferkessedougou","Gagnoa","Grand-Bassam","Guiglo","Issia","Katiola","Korhogo","Lakota","Man","Odienné","Oumé","San-Pédro","Séguéla","Sinfra","Soubré","Tiassalé","Tingréla","Toumodi","Vavoua","Yamoussoukro","Zuénoula"]
